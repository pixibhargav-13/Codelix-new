...
const Footer = () => {
  const footerData = {
    ...
    contact: [
      { label: 'Sales@codelixitsolution.com', link: 'mailto:Sales@codelixitsolution.com' },
    ...
    <footer className="codelix-footer">
      ...
      <div className="marquee-container">
        <div className="marquee-content">
          ...
          <span className="dot"><img src={footerDot}/></span>
          <span>WE LIVE IN IT</span>
                   <span className="dot"><img src={footerDot}/></span>
        ...
        <div className="footer-bottom">
          <div className="container">
            <div className="footer-bottom-content">
              <p className="copyright"><span><i class="fa-regular fa-copyright"></i></span> 2025 Codelix — All Copyright Reserved</p>
      ...
      <div className="codelix-large-text">
        <div className="codelix-text"><img src={codelixText}/></div>
      </div>
    </footer>
  );
};
