              ...
              <div className="col-lg-7 h-100">
                <div className="p-4 border border-secondary h-100">
                  ...
                  <p className="mt-3 light-gray inter">
                    ...
                    businesses with performance, precision, and design excellence
                    through world-class UI/UX design.
                  </p>

                  <div className="d-flex gap-3 mt-4 hero-buttons">
  {/* Blue Button */}
  <button className="btn free-quote-btn px-3 py-2 d-flex align-items-center">
    <span className="me-3">Get a Free Quote</span>
    <img src={whiteArrow} alt="arrow" className="arrow-icon" />
  </button>

  {/* White Button */}
  <button className="btn explore-work-btn px-3 py-2 d-flex align-items-center">
    <span className="me-3 text-dark">Explore Our Work</span>
    <img src={blackArrow} alt="arrow" className="arrow-icon" />
              ...
              <div className="col-lg-5 h-100">
                <div className="border border-secondary d-flex justify-content-center align-items-center h-100 no-spacing">
                  <img src={hero} alt="hero" className="img-fluid right-image"/>
                </div>
              </div>
            </div>
